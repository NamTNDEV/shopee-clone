...
export default function Header() {
  const { isAuth, setIsAuth, setProfile, profile } = useContext(AppContext)
      ...
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            customX={-40}
            arrowX={-40}
            customTransformOrigin={40}
            className='flex items-center hover:text-white/70 cursor-pointer'
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col py-2 pr-28 pl-3'>
                  <button className='py-2 px-3 hover:text-orange-600'>Tiếng Việt</button>
                  <button className='py-2 px-3 hover:text-orange-600 mt-2'>English</button>
                </div>
              </div>
            }
          >
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        ...
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange-600'>₫469.000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
