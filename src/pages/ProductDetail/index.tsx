                ...
                {currentImages.map((img) => {
                  ...
                  return (
                    <div className='relative w-full pt-[100%]' key={img} onMouseEnter={() => chooseActive(img)}>
                      ...
                      />
                      {isActive && <div className='absolute inset-0 border-2 border-solid border-orange-600' />}
                    </div>
                  )
                })}
                <button
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  <span className='mr-1 border-b border-b-orange text-orange-600'>{product.rating}</span>
                  <ProductRating
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                <div className='text-gray-500 line-through'>
                  ₫{FormatUtils.numberToCurrency(product.price_before_discount)}
                </div>
                <div className='ml-3 text-3xl font-medium text-orange-600'>
                  ₫{FormatUtils.numberToCurrency(product.price)}
                </div>
              ...
              <div className='mt-8 flex items-center'>
                <button className='flex h-12 items-center justify-center rounded-sm border border-orange-600 bg-orange-600/10 px-5 capitalize text-orange-600 shadow-sm hover:bg-orange-600/5'>
                  <svg
        ...
        <div className='container'>
          ...
          {productsData && (
            <div className='mt-6 grid grid-cols-2 gap-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6'>
              {productsData.data.data.products.map((productRender) => {
                if (productRender._id !== product._id) {
                  return (
                    <div className='col-span-1' key={productRender._id}>
                      <Product product={productRender} />
                    </div>
                  )
                }
              })}
